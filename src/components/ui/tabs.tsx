  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-10 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        title: "h-auto! gap-4 rounded-none bg-transparent p-0",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=title]/tabs-list:h-auto group-data-[variant=title]/tabs-list:border-0 group-data-[variant=title]/tabs-list:flex-none group-data-[variant=title]/tabs-list:rounded-none group-data-[variant=title]/tabs-list:bg-transparent group-data-[variant=title]/tabs-list:px-0 group-data-[variant=title]/tabs-list:py-0 group-data-[variant=title]/tabs-list:font-heading group-data-[variant=title]/tabs-list:text-sm group-data-[variant=title]/tabs-list:leading-snug group-data-[variant=title]/tabs-list:font-medium group-data-[variant=title]/tabs-list:text-muted-foreground/60 group-data-[variant=title]/tabs-list:data-active:bg-transparent group-data-[variant=title]/tabs-list:data-active:text-foreground group-data-[variant=title]/tabs-list:[&_[data-slot=badge]]:-my-1 dark:group-data-[variant=title]/tabs-list:data-active:border-transparent dark:group-data-[variant=title]/tabs-list:data-active:bg-transparent",
